...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        # n_embd: I want to create like a level of interaction here. We don't directly go to
        ...
        # A linear layer from the token embeddings to the logits
    ...
    def forward(self, idx, targets=None):
        ...
        # here this is not going to give us logits directly, but instead it's going to give us
        #   token embeddings. And go from the token embeddings to the logits, we're going to need
        #   a linear layer.
